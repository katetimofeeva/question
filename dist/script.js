...
/* harmony import */ var _modules_data_from_modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/data_from_modal */ "./src/js/modules/data_from_modal.js");
...
window.addEventListener('DOMContentLoaded', function () {
  'use strict'; // создаю объект для хранения информации из модальных окон
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(modalData);
  Object(_modules_data_from_modal__WEBPACK_IMPORTED_MODULE_4__["default"])(modalData);
...
var checkInputs = function checkInputs(selector) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var clearData = function clearData(data) {
  for (var key in data) {
    switch (key) {
      case 'height':
        data.height = 0;
...
/* harmony default export */ __webpack_exports__["default"] = (clearData);

/***/ }),

/***/ "./src/js/modules/data_from_modal.js":
/*!*******************************************!*\
  !*** ./src/js/modules/data_from_modal.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var _check_input__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./check_input */ "./src/js/modules/check_input.js");



var dataFromModal = function dataFromModal(data) {
  var windowModel = document.querySelectorAll('.balcon_icons_img '),
      windowWidth = document.querySelectorAll('#width'),
      windowHeight = document.querySelectorAll('#height'),
      windowProfile = document.querySelectorAll('#view_type'),
      windowCheckbox = document.querySelectorAll('.checkbox');
  Object(_check_input__WEBPACK_IMPORTED_MODULE_1__["default"])('#width');
  Object(_check_input__WEBPACK_IMPORTED_MODULE_1__["default"])('#height');
        ...
        switch (item.nodeName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              ...
              element.forEach(function (check, j) {
                check.checked = false;
...
/* harmony default export */ __webpack_exports__["default"] = (dataFromModal);
...
/* harmony import */ var _check_input__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./check_input */ "./src/js/modules/check_input.js");
/* harmony import */ var _clearData__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./clearData */ "./src/js/modules/clearData.js");
...
var forms = function forms(dataModal) {
  var forms = document.querySelectorAll('form'),
      inputs = document.querySelectorAll('input');
  Object(_check_input__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]');
  var message = {
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', data).then(function (res) {
        ...
        return messageStatus.textContent = message.error;
      }).finally(function () {
        clearInput();
        setTimeout(function () {
      ...
      Object(_clearData__WEBPACK_IMPORTED_MODULE_6__["default"])(dataModal);
      closeModalWindow();
...
var modals = function modals() {
  function bindModal(buttonSelector, modalSelector, closeSelector) {
    var closeALL = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    var button = document.querySelectorAll(buttonSelector),
        modal = document.querySelector(modalSelector),
        close = document.querySelector(closeSelector),
        scroll = calcScroll(); //windows = document.querySelectorAll('[data-modal]');
...
var photo = function photo() {
  var photoContainer = document.querySelector('.works'),
...
var tabs = function tabs(headerSelector, tabsSelector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (e) {
    ...
    if (target && (target.classList.contains(tabsSelector.slice(1)) || target.parentNode.classList.contains(tabsSelector.replace(/\./, "")))) {
...
var timer = function timer(id, deadline) {
  ...
  function setClock(selector, endtime) {
    var timer = document.querySelector(selector),
        ...
        timeInterval = setInterval(updateClock, 1000); //console.log(timer, day, hours, minutes, seconds);
